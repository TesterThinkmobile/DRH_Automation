...
public abstract class BasePage extends Settings {
...
//        this.PAGE_URL = path;
    ...
    protected void clickElementAndWait(By selector) throws InterruptedException {
        clickElement(selector);
        wait_sec();
    }

    protected void clickElementAndWait(By selector, int sleep) throws InterruptedException {
        clickElement(selector);
        wait_sec();
    }
